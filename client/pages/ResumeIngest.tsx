  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const rawTextForStorage =
        text || `[Content Processed via OCR]\n\n${parsedData.summary}`;

      const candidate = addOrUpdateCandidate(
        parsedData,
        rawTextForStorage,
        referrer || "System",
      );
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500">
          Upload PDF, DOCX, or Text files to automatically extract candidate
          data.
        </p>
      </div>
