        ...
        <div className="relative z-10 w-full max-w-md flex flex-col items-center">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 leading-relaxed">
              An AI-powered, time-aware Resume Intelligence Platform with
              built-in Role Matching, Candidate Comparison and AI-generated
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            ...
            <div className="col-span-2 bg-gradient-to-r from-indigo-600 to-blue-600 p-5 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-transform duration-300 cursor-default">
              <div className="flex items-center justify-between text-white mb-3">
                ...
                <div className="text-[10px] bg-white/20 px-2 py-0.5 rounded font-bold uppercase tracking-wider">
                  Feature
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3 overflow-hidden">
                  <div className="w-8 h-8 rounded-full border-2 border-indigo-500 bg-white flex items-center justify-center text-indigo-700 text-[10px] font-bold">
                    JD
                  </div>
                  <div className="w-8 h-8 rounded-full border-2 border-indigo-500 bg-white flex items-center justify-center text-purple-700 text-[10px] font-bold">
                    AS
                  </div>
                  <div className="w-8 h-8 rounded-full border-2 border-indigo-500 bg-white flex items-center justify-center text-blue-700 text-[10px] font-bold">
                    MR
                  </div>
                </div>
